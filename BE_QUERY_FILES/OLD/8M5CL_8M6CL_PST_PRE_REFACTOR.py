...
def process_defect_data():
    ...
    # Define desired column order (including new DP failure column)
    desired_order = [
        ...
        'RAW_LEAK_RATE', 'SMOOTH_LEAK_RATE', 'DP_FAIL_HRS'  # Add new DP failure column
    ]
...
if __name__ == "__main__":
    ...
    # Save the result
    save_path = r"\\orshfs.intel.com\ORAnalysis$\1276_MAODATA\Config\etch\AME\tbatson\Defects\BE\8M5CL_8M6CL_NCDD_PST.csv"
